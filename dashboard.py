...
# # Make sure you have a report_generator.py file with these functions
...
# else:
#     # Default file load if no file is uploaded
#     try:
...
# # These are the default and max values from your original code
...
#         max_value=max_allowed_date   # Physically stops the calendar from going past this date
#     )
...
# # Corrected method to update the layout
# data1.update_layout(
...
# # ... after the scatter plot section ...
...
#     # Combine scores to create RFM segment and score
...
if fl is not None:
    ...
    # The app will no longer try to access your local C: drive.
    # It will look for "Superstore.csv" in the same cloud folder.
    try:
        df = pd.read_csv("Superstore.csv", encoding="ISO-8859-1")
    except FileNotFoundError:
        st.error("Default file 'Superstore.csv' not found. Please upload a file.")
